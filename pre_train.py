...
gflags.DEFINE_string('dev_data_dir', './inputs/dev/', 'Directory of the dev data.')
...
gflags.DEFINE_integer('num_epochs', 10, 'Number of training epochs (default: 200).')
...
model = keras.models.Model(inputs=base_model.input, outputs=add_model(base_model.output))
